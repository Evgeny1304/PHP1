...
function addCart()
{
    if ($_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        if (!empty($_SESSION['cart'][$_SESSION['userId']][$row['id']])) {
            $_SESSION['cart'][$_SESSION['userId']][$row['id']]['quantity']++;
        } else {
            $_SESSION['cart'][$_SESSION['userId']][$row['id']] = $row;
            $_SESSION['cart'][$_SESSION['userId']][$row['id']]['quantity'] = 1;
        }
